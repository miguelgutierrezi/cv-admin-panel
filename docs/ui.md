...
- **Empty tablet portrait:** `admin-experiences-list-empty-tablet-portrait` (`74:395`, ~768) — empty pad `80px 24px`, empty title 18px, CTA neon; shell `grep experience…` @ 180px (mismo chrome que populated).
