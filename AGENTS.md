...
Current repo state: **Phase 6 done**; **login + home dashboard Figma done** ([docs/ui.md](docs/ui.md) — desktop `41:4`, tablet portrait `61:4`). Next: Phase 7 / editorial Figma when asked. Operator: Sanity CORS + redeploy CV.
