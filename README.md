...
**Phase 6 polish + go-live — done**. **Login UI** + **home dashboard** (Figma `41:4`) — [docs/ui.md](docs/ui.md). Next: Phase 7 / editorial Figma screens when ready. Operator: Sanity CORS + redeploy CV.
