...
Repo status: Phase 6 done; login + home dashboard Figma done (`docs/ui.md` — `41:4` / `61:161` / `61:4` / mobile `61:315`). Next: Phase 7 / editorial Figma when asked. Canonical agent entry: `AGENTS.md`.
